...
error_probability = 0  # Probability that an entire value receives bit error, not a single bit
...
axs.plot(time_vals, percentage_vals)
axs.set_xlabel('Time')
axs.set_ylabel('% Sorted')
axs.set_title(str(error_probability/bit_length) + " Bit Error Rate")
plt.show()
